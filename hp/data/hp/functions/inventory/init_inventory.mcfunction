...
execute as @s[tag=!isContainer,tag=!buy,tag=!sell,scores={playerID=1}] run bossbar set minecraft:player1info name {"text":"Inventario","bold":true,"color":"gray"}
execute as @s[tag=!isContainer,tag=!buy,tag=!sell,scores={playerID=2}] run bossbar set minecraft:player2info name {"text":"Inventario","bold":true,"color":"gray"}
execute as @s[tag=!isContainer,tag=!buy,tag=!sell,scores={playerID=3}] run bossbar set minecraft:player3info name {"text":"Inventario","bold":true,"color":"gray"}
execute as @s[tag=!isContainer,tag=!buy,tag=!sell,scores={playerID=4}] run bossbar set minecraft:player4info name {"text":"Inventario","bold":true,"color":"gray"}
execute as @s[tag=isContainer,tag=!buy,tag=!sell,scores={playerID=1}] run bossbar set minecraft:player1info name {"text":"Contenedor","bold":true,"color":"gray"}
execute as @s[tag=isContainer,tag=!buy,tag=!sell,scores={playerID=2}] run bossbar set minecraft:player2info name {"text":"Contenedor","bold":true,"color":"gray"}
execute as @s[tag=isContainer,tag=!buy,tag=!sell,scores={playerID=3}] run bossbar set minecraft:player3info name {"text":"Contenedor","bold":true,"color":"gray"}
execute as @s[tag=isContainer,tag=!buy,tag=!sell,scores={playerID=4}] run bossbar set minecraft:player4info name {"text":"Contenedor","bold":true,"color":"gray"}
