...
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1504,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2..4},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1503,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=1,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Compra 'Animales Fantasticos Y Como Encontrarlos'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=3,playerID=1,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Compra 'Libro de Encantamientos Basico'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=4,playerID=1,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Compra 'Creacion de Pociones Avanzada'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=5,playerID=1,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Compra 'Las Fuerzas Oscuras: Una guia para autoproteccion'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=6,playerID=1,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Compra 'Guia de Transformaciones Para Principiantes'","color":"gold"}]

execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=2,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Compra 'Animales Fantasticos Y Como Encontrarlos'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=3,playerID=2,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Compra 'Libro de Encantamientos Basico'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=4,playerID=2,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Compra 'Creacion de Pociones Avanzada'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=5,playerID=2,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Compra 'Las Fuerzas Oscuras: Una guia para autoproteccion'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=6,playerID=2,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Compra 'Guia de Transformaciones Para Principiantes'","color":"gold"}]

execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=3,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Compra 'Animales Fantasticos Y Como Encontrarlos'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=3,playerID=3,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Compra 'Libro de Encantamientos Basico'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=4,playerID=3,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Compra 'Creacion de Pociones Avanzada'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=5,playerID=3,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Compra 'Las Fuerzas Oscuras: Una guia para autoproteccion'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=6,playerID=3,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Compra 'Guia de Transformaciones Para Principiantes'","color":"gold"}]

execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=4,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Compra 'Animales Fantasticos Y Como Encontrarlos'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=3,playerID=4,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Compra 'Libro de Encantamientos Basico'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=4,playerID=4,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Compra 'Creacion de Pociones Avanzada'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=5,playerID=4,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Compra 'Las Fuerzas Oscuras: Una guia para autoproteccion'","color":"gold"}]
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=6,playerID=4,conv=29},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Compra 'Guia de Transformaciones Para Principiantes'","color":"gold"}]
