...
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1351,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1350,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1349,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"¡Derrota a 3 Oleadas de enemigos!","color":"gold"}]
execute as @s[scores={questState=3,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"¡Derrota a 3 Oleadas de enemigos!","color":"gold"}]
execute as @s[scores={questState=3,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"¡Derrota a 3 Oleadas de enemigos!","color":"gold"}]
execute as @s[scores={questState=3,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"¡Derrota a 3 Oleadas de enemigos!","color":"gold"}]
...
execute as @s[scores={questState=3,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Oleada 1","color":"gold"}]	
execute as @s[scores={questState=3,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Oleada 1","color":"gold"}]
execute as @s[scores={questState=3,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Oleada 1","color":"gold"}]
execute as @s[scores={questState=3,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Oleada 1","color":"gold"}]
...
execute as @s[scores={questState=3,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=3,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=3,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=3,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
...
execute as @s[scores={questState=4,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"¡Oleada completa!","color":"gold"}]
execute as @s[scores={questState=4,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"¡Oleada completa!","color":"gold"}]
execute as @s[scores={questState=4,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"¡Oleada completa!","color":"gold"}]
execute as @s[scores={questState=4,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"¡Oleada completa!","color":"gold"}]
...
execute as @s[scores={questState=4,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Oleada 2","color":"gold"}]
execute as @s[scores={questState=4,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Oleada 2","color":"gold"}]
execute as @s[scores={questState=4,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Oleada 2","color":"gold"}]
execute as @s[scores={questState=4,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Oleada 2","color":"gold"}]
...
execute as @s[scores={questState=4,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=4,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=4,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=4,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
...
execute as @s[scores={questState=5,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 101..200 run bossbar set minecraft:player1quest name ["",{"text":"¡Oleada completa!","color":"gold"}]
execute as @s[scores={questState=5,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 101..200 run bossbar set minecraft:player2quest name ["",{"text":"¡Oleada completa!","color":"gold"}]
execute as @s[scores={questState=5,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 101..200 run bossbar set minecraft:player3quest name ["",{"text":"¡Oleada completa!","color":"gold"}]
execute as @s[scores={questState=5,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 101..200 run bossbar set minecraft:player4quest name ["",{"text":"¡Oleada completa!","color":"gold"}]
...
execute as @s[scores={questState=5,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 1..100 run bossbar set minecraft:player1quest name ["",{"text":"Oleada 3","color":"gold"}]
execute as @s[scores={questState=5,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 1..100 run bossbar set minecraft:player2quest name ["",{"text":"Oleada 3","color":"gold"}]
execute as @s[scores={questState=5,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 1..100 run bossbar set minecraft:player3quest name ["",{"text":"Oleada 3","color":"gold"}]
execute as @s[scores={questState=5,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 1..100 run bossbar set minecraft:player4quest name ["",{"text":"Oleada 3","color":"gold"}]
...
execute as @s[scores={questState=5,playerID=1},tag=isTrackedQuest] if score elikElixersRatsTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=5,playerID=2},tag=isTrackedQuest] if score elikElixersRatsTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=5,playerID=3},tag=isTrackedQuest] if score elikElixersRatsTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
execute as @s[scores={questState=5,playerID=4},tag=isTrackedQuest] if score elikElixersRatsTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Derrota a los oponentes (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" de 9)","color":"gold"}]
...
execute as @s[scores={questState=6},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1348,Unbreakable:1b,qDetect:1b}
...
execute as @s[tag=completeQuest] store result entity 85e9b3cd-e941-46cc-9f51-24e733358a40 ArmorItems[3].tag."storedItem.EssenceOfBranquialgas.count" int 1 run scoreboard players set tmp tmp 1
...
execute as @s[tag=completeQuest] store result entity 85e9b3cd-e941-46cc-9f51-24e733358a40 ArmorItems[3].tag."invItem.EssenceOfBranquialgas.count" int 1 run scoreboard players set tmp tmp 1
