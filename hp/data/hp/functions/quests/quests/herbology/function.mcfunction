...
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1523,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1522,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3,playerID=1},tag=isTrackedQuest,tag=!inConversation,tag=isTrackedQuest,tag=!inProperCutScene,tag=!inResetPoint] run bossbar set minecraft:player1quest name ["",{"text":"Recoge las 4 estrellas (","color":"gold"},{"score":{"name":"collectedHerbologyStars","objective":"sharedQuests"},"color":"gold"},{"text":" / 4)","color":"gold"}]
execute as @s[scores={questState=3,playerID=2},tag=isTrackedQuest,tag=!inConversation,tag=isTrackedQuest,tag=!inProperCutScene,tag=!inResetPoint] run bossbar set minecraft:player2quest name ["",{"text":"Recoge las 4 estrellas (","color":"gold"},{"score":{"name":"collectedHerbologyStars","objective":"sharedQuests"},"color":"gold"},{"text":" / 4)","color":"gold"}]
execute as @s[scores={questState=3,playerID=3},tag=isTrackedQuest,tag=!inConversation,tag=isTrackedQuest,tag=!inProperCutScene,tag=!inResetPoint] run bossbar set minecraft:player3quest name ["",{"text":"Recoge las 4 estrellas (","color":"gold"},{"score":{"name":"collectedHerbologyStars","objective":"sharedQuests"},"color":"gold"},{"text":" / 4)","color":"gold"}]
execute as @s[scores={questState=3,playerID=4},tag=isTrackedQuest,tag=!inConversation,tag=isTrackedQuest,tag=!inProperCutScene,tag=!inResetPoint] run bossbar set minecraft:player4quest name ["",{"text":"Recoge las 4 estrellas (","color":"gold"},{"score":{"name":"collectedHerbologyStars","objective":"sharedQuests"},"color":"gold"},{"text":" / 4)","color":"gold"}]
...
execute as @s[scores={questState=4},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1521,Unbreakable:1b,qDetect:1b}
