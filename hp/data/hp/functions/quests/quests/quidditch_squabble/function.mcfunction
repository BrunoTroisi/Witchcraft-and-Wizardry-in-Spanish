...
execute as @s[scores={questState=1},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1376,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=2},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1375,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3..60},tag=isTrackedQuest] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1374,Unbreakable:1b,qDetect:1b}
...
execute as @s[scores={questState=3,playerID=1},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Ve a la zona marcada y salta en la escoba","color":"gold"}]
execute as @s[scores={questState=3,playerID=2},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Ve a la zona marcada y salta en la escoba","color":"gold"}]
execute as @s[scores={questState=3,playerID=3},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Ve a la zona marcada y salta en la escoba","color":"gold"}]
execute as @s[scores={questState=3,playerID=4},tag=!inConversation,tag=!inProperCutScene,tag=!inResetPoint,tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Ve a la zona marcada y salta en la escoba","color":"gold"}]
...
execute as @s[scores={questState=13..59,playerID=1,tmp2=10..},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Completa una vuelta antes de que se agote el temporizador (","color":"gold"},{"score":{"name":"@s","objective":"tmp3"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"@s","objective":"tmp2"},"color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=13..59,playerID=3,tmp2=10..},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Completa una vuelta antes de que se agote el temporizador (","color":"gold"},{"score":{"name":"@s","objective":"tmp3"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"@s","objective":"tmp2"},"color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=13..59,playerID=2,tmp2=10..},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Completa una vuelta antes de que se agote el temporizador (","color":"gold"},{"score":{"name":"@s","objective":"tmp3"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"@s","objective":"tmp2"},"color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=13..59,playerID=4,tmp2=10..},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Completa una vuelta antes de que se agote el temporizador (","color":"gold"},{"score":{"name":"@s","objective":"tmp3"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"@s","objective":"tmp2"},"color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=13..59,playerID=1,tmp2=..9},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Completa una vuelta antes de que se agote el temporizador (","color":"gold"},{"score":{"name":"@s","objective":"tmp3"},"color":"gold"},{"text":":0","color":"gold"},{"score":{"name":"@s","objective":"tmp2"},"color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=13..59,playerID=3,tmp2=..9},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Completa una vuelta antes de que se agote el temporizador (","color":"gold"},{"score":{"name":"@s","objective":"tmp3"},"color":"gold"},{"text":":0","color":"gold"},{"score":{"name":"@s","objective":"tmp2"},"color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=13..59,playerID=2,tmp2=..9},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Completa una vuelta antes de que se agote el temporizador (","color":"gold"},{"score":{"name":"@s","objective":"tmp3"},"color":"gold"},{"text":":0","color":"gold"},{"score":{"name":"@s","objective":"tmp2"},"color":"gold"},{"text":")","color":"gold"}]
execute as @s[scores={questState=13..59,playerID=4,tmp2=..9},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Completa una vuelta antes de que se agote el temporizador (","color":"gold"},{"score":{"name":"@s","objective":"tmp3"},"color":"gold"},{"text":":0","color":"gold"},{"score":{"name":"@s","objective":"tmp2"},"color":"gold"},{"text":")","color":"gold"}]
...
execute as @s[scores={questState=59,playerID=1},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Fuiste demasiado lento.","color":"red"}]
execute as @s[scores={questState=59,playerID=3},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Fuiste demasiado lento.","color":"red"}]
execute as @s[scores={questState=59,playerID=2},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Fuiste demasiado lento.","color":"red"}]
execute as @s[scores={questState=59,playerID=4},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Fuiste demasiado lento.","color":"red"}]
...
execute as @s[scores={questState=60,playerID=1},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Venciste el tiempo de Marcus Flint!","color":"gold"}]
execute as @s[scores={questState=60,playerID=3},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Venciste el tiempo de Marcus Flint!!","color":"gold"}]
execute as @s[scores={questState=60,playerID=2},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Venciste el tiempo de Marcus Flint!!","color":"gold"}]
execute as @s[scores={questState=60,playerID=4},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Venciste el tiempo de Marcus Flint!!","color":"gold"}]
...
execute as @s[scores={questState=70}] if entity @s[tag=showingTrackedQuest,tag=!playingQuestAnim,tag=drawingNormalHotbar,tag=takeOverInventory] if score @s questID = @s trackedQuestID run replaceitem entity @s hotbar.1 minecraft:diamond_axe{display:{Name:"{\"text\":\"Mapa del Meroeador\",\"color\":\"gold\",\"bold\":true}"},HideFlags:63,Damage:1373,Unbreakable:1b,qDetect:1b}
