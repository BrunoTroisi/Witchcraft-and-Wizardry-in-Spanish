...
execute as @s[scores={questMenu=1},tag=!preventDoubleExecution,tag=lockTrackedQuest,tag=!noQuests] run title @s subtitle {"text":"No puedes cambiar tu puntero a la mision ahora","bold":false,"color":"red"}
