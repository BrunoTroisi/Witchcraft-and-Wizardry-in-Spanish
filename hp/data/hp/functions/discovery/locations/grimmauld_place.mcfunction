# On Discover
execute as @s[tag=!discovered_grimmauld_place,scores={playerID=1},tag=!inProperCutScene] run bossbar set minecraft:player1empty name {"text":"Descubierto","color":"white","italic":"true"}
execute as @s[tag=!discovered_grimmauld_place,scores={playerID=2},tag=!inProperCutScene] run bossbar set minecraft:player2empty name {"text":"Descubierto","color":"white","italic":"true"}
execute as @s[tag=!discovered_grimmauld_place,scores={playerID=3},tag=!inProperCutScene] run bossbar set minecraft:player3empty name {"text":"Descubierto","color":"white","italic":"true"}
execute as @s[tag=!discovered_grimmauld_place,scores={playerID=4},tag=!inProperCutScene] run bossbar set minecraft:player4empty name {"text":"Descubierto","color":"white","italic":"true"}
