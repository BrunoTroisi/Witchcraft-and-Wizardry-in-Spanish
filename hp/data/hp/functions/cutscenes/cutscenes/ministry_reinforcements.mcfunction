...
execute as @s[scores={cutSceneTimer=20..110}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" ¡No te preocupes, estoy aquí! He traído refuerzos ..."}]
...
execute as @s[scores={cutSceneTimer=111..200}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" Oh. Parece que tienes esta situación bajo control."}]
...
execute as @s[scores={cutSceneTimer=201..300}] run title @s actionbar ["",{"text":""},{"text":"Ministry Worker:","color":"dark_gray"},{"text":" ¿Que situación? Mortifagos...?Disparates.¡Estas son afirmaciones escandalosas!"}]
...
execute as @s[scores={cutSceneTimer=301..360}] run title @s actionbar ["",{"text":""},{"text":"Ministry Worker:","color":"dark_gray"},{"text":" Me parece claro lo que pasó aquí."}]
...
execute as @s[scores={cutSceneTimer=361..450}] run title @s actionbar ["",{"text":""},{"text":"Ministry Worker:","color":"dark_gray"},{"text":" Uno de sus estudiantes explotó accidentalmente esta pared, y ahora estás tratando de cubrirlo."}]
...
execute as @s[scores={cutSceneTimer=451..540}] run title @s actionbar ["",{"text":""},{"text":"Ministry Worker:","color":"dark_gray"},{"text":" Te estoy vigilando, Twycross."}]
