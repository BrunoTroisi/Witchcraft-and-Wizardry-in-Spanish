...
execute as @s[scores={cutSceneTimer=20..160}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" ¡Bienvenidos otra vez, estudiantes!"}]
...
execute as @s[scores={cutSceneTimer=161..350}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Ahora, una de las habilidades más rudimentarias de un mago es la levitación: la capacidad de hacer que los objetos vuelan."}]
...
execute as @s[scores={cutSceneTimer=351..500}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" El encantamiento 'Wingardium Leviosa' les permitirá hacer levitar ciertos objetos."}]
...
execute as @s[scores={cutSceneTimer=500..600}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Para centrarse en un objeto para hacerlo levitar, comiencen por hacer doble clic en £."}]
...
execute as @s[scores={cutSceneTimer=601..690}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Después de eso, pueden hacer clic en € una vez para hacer levitar el objeto que están mirando,"}]
...
execute as @s[scores={cutSceneTimer=691..760}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" y hacer clic en € de nuevo para liberarlo."}]
...
execute as @s[scores={cutSceneTimer=761..850}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Cuando estes haciendo levitar un objeto simplemente mira donde quieres que vaya.."}]
...
execute as @s[scores={cutSceneTimer=861..950}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Pueden usar la rueda del mouse para ajustar su distancia a ustedes."}]
...
execute as @s[scores={cutSceneTimer=951..1050}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Cuando hayan terminado, pueden desenfrenarlo al hacer doble clic en £ nuevamente."}]
...
execute as @s[scores={cutSceneTimer=1051..1200}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":"Este hechizo es particularmente útil para mover bloques pesados hacia interruptores, para activar sus mecanismos."}]
...
execute as @s[scores={cutSceneTimer=1201..1350}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":"He puesto un recorrido de obstáculos que necesitará que uses el hechizo de levitación.."}]
...
execute as @s[scores={cutSceneTimer=1351..1420}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" ¡La mejor de las suertes!"}]
