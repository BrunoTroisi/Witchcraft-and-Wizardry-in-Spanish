...
execute as @s[scores={cutSceneTimer=20..160}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" ¡Excelente trabajo!"}]
...
execute as @s[scores={cutSceneTimer=161..311}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Ya has aprendido a apuntar y disparar al hechizo.Ahora por un poco más de un desafío."}]
...
execute as @s[scores={cutSceneTimer=311..400}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" No estés nervios@."}]
...
execute as @s[scores={cutSceneTimer=400..480}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" En estos armarios hay 'boggarts'."}]
...
execute as @s[scores={cutSceneTimer=480..650}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Forma criaturas cambiantes que habitan en lugares oscuros y toman forma para asustar a su objetivo"}]
...
execute as @s[scores={cutSceneTimer=650..800}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Quiero que luches con el hechizo aturdidos, para que puedas practicar tus habilidades de combate."}]
...
execute as @s[scores={cutSceneTimer=800..950}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" ¡La mejor de las suertes!"}]
