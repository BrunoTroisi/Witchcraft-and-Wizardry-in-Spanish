...
execute as @s[scores={cutSceneTimer=20..160}] run title @s actionbar ["",{"text":""},{"text":"Fliwtick:","color":"dark_gray"},{"text":" ¡Bienvenido de nuevo a mis alumnos! "}]
...
execute as @s[scores={cutSceneTimer=161..300}] run title @s actionbar ["",{"text":""},{"text":"Fliwtick:","color":"dark_gray"},{"text":" Ya han aprendido que pueden curarse usando pociones."}]
...
execute as @s[scores={cutSceneTimer=301..450}] run title @s actionbar ["",{"text":""},{"text":"Fliwtick:","color":"dark_gray"},{"text":" En esta lección aprenderán el hechizo. 'Brackium Emendo' Como otra forma de restaurar su salud después de una pelea."}]
...
execute as @s[scores={cutSceneTimer=450..520}] run title @s actionbar ["",{"text":""},{"text":"Fliwtick:","color":"dark_gray"},{"text":" ¡He establecido una arena para que pruebes el hechizo!"}]
...
execute as @s[scores={cutSceneTimer=521..630}] run title @s actionbar ["",{"text":""},{"text":"Fliwtick:","color":"dark_gray"},{"text":" Lucha contra los enemigos, y usa el hechizo para curarte si recibes daño."}]
...
execute as @s[scores={cutSceneTimer=630..740}] run title @s actionbar ["",{"text":""},{"text":"Fliwtick:","color":"dark_gray"},{"text":" Al mantener 'shift' y ˈˈˈPresionar '{' al mismo tiempo, puedes cambiar rápidamente entre hechizos relevantes de combate."}]
...
execute as @s[scores={cutSceneTimer=741..862}] run title @s actionbar ["",{"text":""},{"text":"Fliwtick:","color":"dark_gray"},{"text":" ¡La mejor de las suertes!"}]
