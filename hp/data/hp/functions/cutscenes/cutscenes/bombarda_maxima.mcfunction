...
execute as @s[scores={cutSceneTimer=20..120}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" ¡Hola estudiantes!"}]
...
execute as @s[scores={cutSceneTimer=121..210}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Hoy aprenderemos a usar. 'Bombarda Maxima'"}]
...
execute as @s[scores={cutSceneTimer=211..300}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Una fuerte variación del encantamiento 'Bombarda'."}]
...
execute as @s[scores={cutSceneTimer=300..400}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Esto le permitirá conjurar explosiones poderosas,"}]
...
execute as @s[scores={cutSceneTimer=400..550}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Capaz de generar un gran daño a múltiples enemigos, así como explotar ciertas paredes y objetos."}]
...
execute as @s[scores={cutSceneTimer=550..700}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" He establecido un área debajo del castillo donde puedes practicar el hechizo."}]
...
execute as @s[scores={cutSceneTimer=700..900}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" La salida está en la parte superior de la sala principal.A ver si puedes encontrar una manera de llegar hasta alli."}]
...
execute as @s[scores={cutSceneTimer=900..1050}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Ah, y me apuraría si yo fuera tú.El olor no es exactamente agradable."}]
