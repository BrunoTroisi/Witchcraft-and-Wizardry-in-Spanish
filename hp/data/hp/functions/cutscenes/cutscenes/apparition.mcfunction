...
execute as @s[scores={cutSceneTimer=20..120}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" ¿Estamos listos para empezar? Maravilloso."}]
...
execute as @s[scores={cutSceneTimer=121..230}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" Ahora, como sabes, la aparición es una forma mágica de transporte."}]
...
execute as @s[scores={cutSceneTimer=231..300}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":"  instantly transporting you from one location to another."}]
...
execute as @s[scores={cutSceneTimer=301..350}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" This ability can be very useful"}]
...
execute as @s[scores={cutSceneTimer=351..420}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" Y, en ocasiones, necesaria para llegar a áreas que de otro modo serían inaccesibles."}]
...
execute as @s[scores={cutSceneTimer=421..480}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" Let me demonstrate:"}]
...
execute as @s[scores={cutSceneTimer=551..610}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" Algo asi."}]
...
execute as @s[scores={cutSceneTimer=651..800}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" Las cosas importantes para recordar al aparecer son las tres D: "Destino, Determinación, Deliberación"."}]
...
execute as @s[scores={cutSceneTimer=801..870}] run title @s actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" Ahora intentalo tu."}]
