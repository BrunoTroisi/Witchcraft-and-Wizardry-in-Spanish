...
execute as @s[scores={cutSceneTimer=85}] run title @s subtitle ["",{"text":"El Caldero Chorreante","bold":true,"color":"gold"}]
execute as @s[scores={cutSceneTimer=85}] run title @s title {"text":"Viajando a","color":"gray"}
