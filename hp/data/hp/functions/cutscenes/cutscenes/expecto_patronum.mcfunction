...
execute as @s[scores={cutSceneTimer=20..190}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Ahora, antes de comenzar, debo decirle: esta es una magia muy avanzada, mucho más allá del nivel de asistencia normal."}]
...
execute as @s[scores={cutSceneTimer=190..290}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" El hechizo que voy a tratar de enseñarte se le llama un encantamiento de patronus."}]
...
execute as @s[scores={cutSceneTimer=290..410}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Un patronus es un tipo de fuerza positiva, que puede protegerlo contra los dementores."}]
...
execute as @s[scores={cutSceneTimer=410..490}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Un dementor no puede ser asesinado."}]
...
execute as @s[scores={cutSceneTimer=490..610}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Pero con el hechizo del patronus, puedes forzarlo a mantener su distancia, aunque solo sea por un momento."}]
...
execute as @s[scores={cutSceneTimer=610..710}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" El objetivo es producir un ente protector plateado-blanco,"}]
...
execute as @s[scores={cutSceneTimer=710..820}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" que toma la forma de un animal, y que forzará a los dementores a retirarse."}]
...
execute as @s[scores={cutSceneTimer=820..900}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Déjame mostrartelo:"}]
...
execute as @s[scores={cutSceneTimer=960..1020}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Expecto Patronum!"}]
