...
execute as @s[scores={cutSceneTimer=90..200}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":" ¿Podría tener su atención, por favor?"}]
...
execute as @s[scores={cutSceneTimer=200..320}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":" Ahora hoy estaremos aprendiendo el hechizo Vera Verto."}]
...
execute as @s[scores={cutSceneTimer=330..420}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":" Este hechizo le permitirá cambiar la forma y las propiedades de su entorno,"}]
...
execute as @s[scores={cutSceneTimer=420..500}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":" Y los dejará transformar ciertos objetos y enemigos."}]
...
execute as @s[scores={cutSceneTimer=500..560}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":" Algo asi:"}]
...
execute as @s[scores={cutSceneTimer=600..660}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":" Vera Verto"}]
...
execute as @s[scores={cutSceneTimer=700..850}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":"Ahora es tu turno.He preparado una sección del castillo, donde podrías practicar."}]
...
execute as @s[scores={cutSceneTimer=850..1000}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":" Cuando veas partículas azules alrededor de un objeto, podrás transformarlo."}]
...
execute as @s[scores={cutSceneTimer=1000..1090}] run title @s actionbar ["",{"text":""},{"text":"McGonagall:","color":"dark_gray"},{"text":" Ahora, fuera de aqui.¡La mejor de las suertes!"}]
