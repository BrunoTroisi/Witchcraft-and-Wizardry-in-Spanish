...
execute as @s[scores={cutSceneTimer=70..200}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" ¡Bienvenidos todos!Bienvenido a Herbologia 1."}]
...
execute as @s[scores={cutSceneTimer=200..360}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Ahora reúnanse a todos, hoy vamos a aprender a manejar a las mandrágoras."}]
...
execute as @s[scores={cutSceneTimer=360..480}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" ¡El Mandrake, o Mandragora es una planta bastante peligrosa!"}]
...
execute as @s[scores={cutSceneTimer=480..570}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Su grito es fatal para cualquiera que lo escuche,"}]
...
execute as @s[scores={cutSceneTimer=570..670}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Es por eso que debe usar orejeras para la protección auditiva!"}]
...
execute as @s[scores={cutSceneTimer=670..760}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Nuestros mandragoras siguen siendo solo plántulas, por lo que sus gritos probablemente no los matarán todavía,"}]
...
execute as @s[scores={cutSceneTimer=760..860}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Pero tengan cuidado, ciertamente podrían derribarlos durante varias horas."}]
...
execute as @s[scores={cutSceneTimer=860..1000}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":"Si alguna vez tropiezan con una en la naturaleza, tengan cuidado!"}]
...
execute as @s[scores={cutSceneTimer=1001..1100}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Manténgase fuera de rango y traten de evitar molestarla si pueden."}]
...
execute as @s[scores={cutSceneTimer=1101..1200}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Si debe acercarse a ella, asegúrese de tener algunas orejeras equipadas."}]
...
execute as @s[scores={cutSceneTimer=1201..1300}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Cuando usen los orejeras, pueden replantarlas a tierra fertil."}]
...
execute as @s[scores={cutSceneTimer=1301..1370}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" Eso las tranquilizará por un tiempo."}]
...
execute as @s[scores={cutSceneTimer=1371..1510}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" ¡Tengan cuidado de no dejar caer las orejeras!Tendrán que moverse suavemente."}]
...
execute as @s[scores={cutSceneTimer=1511..1700}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":"Para practicar, tendrán que ingresar a los cuatro invernaderos afuera para recoger cuatro estrellas y luego volver a mí."}]
...
execute as @s[scores={cutSceneTimer=1700..1800}] run title @s actionbar ["",{"text":""},{"text":"Sprout:","color":"dark_gray"},{"text":" ¡Buena suerte!"}]
