...
execute as @s[scores={cutSceneTimer=161..230}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Para esta primera clase, aprenderemos un hechizo simple, 'Lumos'"}]
...
execute as @s[scores={cutSceneTimer=231..350}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Lo que les permitirá arrojar luz de la punta de sus varitas para iluminar lugares oscuros."}]
...
execute as @s[scores={cutSceneTimer=351..490}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Cuando están en una habitación que está demasiado oscura para que veas algo,"}]
...
execute as @s[scores={cutSceneTimer=491..590}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Pueden lanzar el hechizo de Lumos al hacer doble clic en ⌠."}]
...
execute as @s[scores={cutSceneTimer=590..700}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Para practicar Lumos, he organizado una tarea especial para usted que debe completar."}]
...
execute as @s[scores={cutSceneTimer=701..780}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" La tarea es simple:"}]
...
execute as @s[scores={cutSceneTimer=781..940}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Recoge las cinco estrellas dispersas a lo largo de este laberinto de corredores, y regresa a mí para completar la lección."}]
...
execute as @s[scores={cutSceneTimer=941..1100}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" Este laberinto es completamente oscuro. Tendrás que usar tu varita para encontrar el camino."}]
...
execute as @s[scores={cutSceneTimer=1101..1180}] run title @s actionbar ["",{"text":""},{"text":"Flitwick:","color":"dark_gray"},{"text":" ¡La mejor de las suertes!"}]
