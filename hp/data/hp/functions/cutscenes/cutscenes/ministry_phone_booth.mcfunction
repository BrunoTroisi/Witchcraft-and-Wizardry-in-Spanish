...
execute as @s[scores={cutSceneTimer=200}] run title @s subtitle ["",{"text":"El Ministerio de Magia","bold":true,"color":"gold"}]
execute as @s[scores={cutSceneTimer=200}] run title @s title {"text":"Viajando a","color":"gray"}
