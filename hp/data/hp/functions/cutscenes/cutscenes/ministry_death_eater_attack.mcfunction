...
# ¤Twycross:¤ By heavens! Mortifagos! They're attacking the Ministry!
execute as @s[scores={cutSceneTimer=650..740}] run title @a[tag=cutsceneSlave] actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" ¡Por cielos!¡Mortifagos!¡Están atacando el ministerio!"}]
...
execute as @s[scores={cutSceneTimer=740..850}] run title @a[tag=cutsceneSlave] actionbar ["",{"text":""},{"text":"Twycross:","color":"dark_gray"},{"text":" Rápido, ¡déjalos!Voy a corr ... uh ... ¡Voy a buscar ayuda!"}]
