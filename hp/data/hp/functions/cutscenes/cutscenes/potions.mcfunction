...
execute as @s[scores={cutSceneTimer=20..140}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":" No habrá una ni varita ondeando o encantamiento en esta clase."}]
...
execute as @s[scores={cutSceneTimer=140..320}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":" Como tal, no espero que muchos de ustedes aprecien la ciencia sutil y el arte exacto que es la preparacion de pociones,"}]
...
execute as @s[scores={cutSceneTimer=320..420}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":" Sin embargo, para aquellos pocos que poseen la predisposición."}]
...
execute as @s[scores={cutSceneTimer=420..600}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":" Puedo enseñarles cómo llegar a la mente, y ensuciar los sentidos."}]
...
execute as @s[scores={cutSceneTimer=510..600}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":" Puedo decirles cómo la embotellar fama, destilar gloria e incluso poner un alto a la muerte."}]
...
# ¤Snape:¤ In this lesson you will be brewing the "Esencia de Murtlap" potion,
...
execute as @s[scores={cutSceneTimer=600..800}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":" En esta lección estarán preparando la poción de 'Esencia de Murtlap'."}]
...
execute as @s[scores={cutSceneTimer=700..800}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":" que cuando se consume restaurará una cantidad significativa de su salud."}]
...
execute as @s[scores={cutSceneTimer=800..970}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":"Para esto necesitaran recolectar una variedad de suministros de pociones que están dispersos por alrededor de esta sala.."}]
...
execute as @s[scores={cutSceneTimer=970..1170}] run title @s actionbar ["",{"text":""},{"text":"Snape:","color":"dark_gray"},{"text":" Pueden comenzar."}]
