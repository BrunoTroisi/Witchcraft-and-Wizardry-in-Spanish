...
execute as @s[scores={cutSceneTimer=20..100}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" ¡Bien hecho!"}]
...
execute as @s[scores={cutSceneTimer=100..240}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Pero aún no has terminado. Sigue subiendo y te encontraré en la cima."}]
