...
execute as @s[scores={cutSceneTimer=20..80}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":"¡Bienvenidos a Defensa contra las artes oscuras!"}]
...
execute as @s[scores={cutSceneTimer=80..160}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Soy el profesor Lupin, Su maestro de Defensa Contra las Artes Oscuras aquí en Hogwarts."}]
...
execute as @s[scores={cutSceneTimer=161..320}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Por favor, guarden sus libros, esta va a ser una lección práctica.Solo necesitarán sus varita."}]
...
execute as @s[scores={cutSceneTimer=320..490}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Hoy Aprenderan el hechizo 'Desmaius', que les permitirá aturdir y dañar a los oponentes."}]
...
execute as @s[scores={cutSceneTimer=490..980}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" He establecido un reccorrudi de obstáculos con objetivos en el que deberas abrirte paso, para que puedas practicar el hechizo."}]
...
execute as @s[scores={cutSceneTimer=980..1110}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" Puede seleccionar el hechizo Desmaius ˈˈˈPresionando { e invocarlo haciendo doble clic en £."}]
...
execute as @s[scores={cutSceneTimer=1110..1200}] run title @s actionbar ["",{"text":""},{"text":"Lupin:","color":"dark_gray"},{"text":" ¡La mejor de las suertes!"}]
