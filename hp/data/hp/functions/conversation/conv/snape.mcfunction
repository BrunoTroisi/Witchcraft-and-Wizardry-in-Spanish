...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" lo haré be teaching you the art of potion-brewing as your Potions Master, \"},{\"text\":\"Professor Severus Snape\",\"color\":\"gold\",\"bold\":\"true\"},{\"text\":\".\\n\\n\\n\\n\",\"color\":\"white\",\"bold\":\"false\"}]"}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" This will suffice for now. You now know how to utilise brewing stands Para destilar Pocions with different effects. Your next lesson is Charms with Professor Flitwick, where you will be learning the spell 'Brackium Emendo'. You may head there when you please. \\n \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
