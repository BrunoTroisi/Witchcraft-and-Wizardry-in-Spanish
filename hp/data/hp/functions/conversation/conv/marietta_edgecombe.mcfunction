...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" ¡Gracias! The underwater plant is bright blue, so it should easy enough to spot. Just return to me here when you have it. \\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
