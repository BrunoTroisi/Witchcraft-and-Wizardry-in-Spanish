...
replaceitem entity @s[scores={editPage=1}] hotbar.4 minecraft:endermite_spawn_egg{display:{Name:"{\"text\":\"Spawn Snitch Dorada\",\"color\":\"gold\",\"italic\":false}"},EntityTag:{NoAI:1b,Tags:["spawnGoldenSnitch"]},qDetect:1b,altFDetect:1b}
...
execute at @e[tag=spawnSmallChest] run summon minecraft:armor_stand ~ ~ ~ {Marker:1b,NoGravity:1b,Team:"NPC",CustomName:"{\"text\":\"Cofre pequeñoˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈ\",\"color\":\"dark_gray\"}",Invulnerable:1b,DisabledSlots:2039583,Invisible:1b,Tags:["chest","smallChest","interactable","glowable","restorable","smallChestBeingSpawned","resettable"],ArmorItems:[{},{},{},{id:"minecraft:wooden_sword",Count:1b,tag:{Unbreakable:1b,Damage:56}}],NoBasePlate:1b}
